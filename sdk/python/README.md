...
```bash
python -m pip install /path/to/semantix/sdk/python/dist/semantix_client-0.1.0-py3-none-any.whl
```

You can also install the package directly from the repository:

```bash
python -m pip install "semantix-client @ git+https://github.com/Yoruxyv/semantix.git@main#subdirectory=sdk/python"
```
